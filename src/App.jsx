    ...
    >
      ...
      <div className="mt-10 flex flex-wrap gap-4 justify-center items-center">
        ...
        <a
          ...
          download="Dhaval_Maicha_Resume.pdf" // Yeh attribute download force karega
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-white text-black font-bold hover:bg-blue-500 hover:text-white transition-all duration-300 transform hover:scale-105 shadow-lg shadow-white/5 cursor-pointer"
        >
          <FileText size={18} />
          Resume
        </a>
